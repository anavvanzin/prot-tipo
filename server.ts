...
Siga estritamente o esquema JSON requerido para a resposta do Conselho.`;
      ...
      const simulatedResponse = {
        ...
        final: {
          ...
          fundamentacao: "Artigo 5º, LV (Constituição Federal); Artigo 20 da Lei Geral de Proteção de Dados (LGPD) corrigindo abusos de IA; Artigo 6º, §2º da Lei 14.129/21 (Explicabilidade).",
