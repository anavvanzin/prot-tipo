...
export const STANDARD_CASES: CaseAnalysis[] = [
  {
    ...
    final: {
      ...
      fundamentacao: "Consubstancia-se na incidência direta do direito fundamental ao contraditório prévio e à ampla defesa (Art. 5º, inciso LV, da Constituição Federal), coadunado com o princípio do devido processo legal substantivo (LIV). O indeferimento automatizado promovido pelo INSS ergue-se como ato nulo de pleno direito, conforme doutrina de Alexandre Santos Aragão e Juarez Freitas, na medida em que a Administração Pública possui o dever de instrução procedimental exaustiva para segurados especiais da previdência de que trata a Instrução Normativa INSS nº 128/2022. Subsidiariamente, incide o direito subjetivo público à explicabilidade algorítmica e à revisão por pessoa natural de decisões tomadas unicamente com esteio em tratamento automatizado de dados, esculpido no Art. 20, caput e §1º, da Lei Geral de Proteção de Dados (LGPD - Lei nº 13.709/18), bem como o princípio da explicabilidade em Governo Digital corporificado expressamente no Art. 6º, §2º, da Lei do Governo Digital (Lei nº 14.129/2021).",
  ...
  },
  {
    ...
    final: {
      ...
      fundamentacao: "Delineia-se sob o postulado da dignidade da pessoa humana (Art. 1º, inciso III, da CF/88) em sua vertente de vedação ao retrocesso social e preservação do mínimo existencial (Art. 6º da CF/88), sopesado com a garantia pétrea do contraditório prévio administrativo (Art. 5º, LV, da CF/88). O cancelamento unilateral do Bolsa Família padece de flagrante desvio de finalidade e vício insanável de forma por banir o exercício de manifestação do beneficiado. Conforme escólio clássico de Celso Antônio Bandeira de Mello e a doutrina contemporânea de Dierle Nunes, atos automáticos repressivos sem contraditório geram exclusão civil. Garante-se o lídimo direito à reversão e à adequada explicabilidade técnica (Art. 20, §1º, da LGPD - Lei nº 13.709/18) de modo a debelar falsos positivos gerados por disparidades temporais e nominais pós-divórcio nas bases de cruzamento da Receita Federal.",
  ...
  },
  {
    ...
    final: {
      ...
      fundamentacao: "Alicerça-se nos primados constitucionais da estrita legalidade tributária (Art. 150, I, CF/88), da indeclinável capacidade contributiva (Art. 145, §1º, CF/88) e do princípio da não-surpresa do contribuinte (Art. 150, III, 'b' e 'c', da CF/88). O lançamento tributário suplementar de IPTU efetuado unicamente por triagem automática de endereço fiscal de MEI, sem prévia notificação e sem a devida vistoria presencial realizada por Auditor Fiscal municipal, afronta o plexo de garantias do processo administrativo-tributário (Art. 5º, LV, CF/88). Conforme doutrina consolidada de Hugo de Brito Machado e Roque Antonio Carrazza, a presunção de legitimidade dos atos administrativos não autoriza o Fisco a criar presunção tributária ficcional de atividade comercial baseada em proxy eletrônico cego, sendo impositiva a cassação do lançamento e a incidência do direito à revisão por pessoa natural assegurado no Art. 20 da LGPD.",
  ...
  },
  {
    ...
    final: {
      ...
      fundamentacao: "Subsume-se na tutela constitucional do mínimo existencial decorrente do direito ao trabalho e à assistência social (Art. 6º da CF/88) e no dever estatal de obediência estrita aos princípios da razoabilidade e proporcionalidade administrativa (Art. 37, caput, CF/88). O indeferimento fulminado por 'registro fantasma' persistente na base do CNIS viola as diretrizes de integridade, acurácia e qualidade dos dados sob gerência governamental exigidas impositivamente pelos Artigos 6º, inciso VII, e 46 da Lei Geral de Proteção de Dados (LGPD). Conforme pontua a jurisprudência previdenciária fixada pelo Superior Tribunal de Justiça (STJ) e a lição doutrinária de Maria Sylvia Zanella Di Pietro, é abusivo e ofensivo à boa-fé legítima impor ao administrado vulnerável a produção de prova de fato negativo indefinido, devendo prevalecer a autodeclaração de desemprego com posterior auditoria humana, salvaguardado pelo Art. 20 da LGPD.",
  ...
  },
  {
    ...
    final: {
      ...
      fundamentacao: "Firma-se sob as balizas fundamentais da dignidade da pessoa humana (Art. 1º, inciso III, CF/88), do direito fundamental de locomoção (Art. 5º, inciso XV) e da reserva constitucional de jurisdição de que decorre a estrita necessidade de fundamentação para reclusão corporal (Art. 5º, inciso LXI). A detenção coercitiva baseada exclusivamente em alerta mecânico de semelhança biométrica de monitoramento dotado de threshold condescendente inverte o princípio da presunção de inocência (Art. 5º, LVII, CF/88) e ignora as salvaguardas fixadas pelo Superior Tribunal de Justiça (STJ) no HC 568.693/SP contra reconhecimentos imprecisos. Submete-se de igual modo ao controle rígido de discriminação indireta e de conformidade estatística em algoritmo policial público, nos moldes delineados pelas diretrizes éticas globais de IA de segurança e pela governança de IA estabelecida pelo Conselho Nacional de Justiça (CNJ).",
  ...
  },
  {
    ...
    final: {
      ...
      fundamentacao: "Consubstancia-se sob o amparo do postulado impositivo do Artigo 203, inciso V, da Constituição Federal, que garante a transferência de renda continuada (BPC/LOAS) à pessoa com deficiência que comprove não possuir meios de prover a própria manutenção. O cancelamento por cruzamento seco em lote ofende o devido processo legal formal e substantivo (Art. 5º, LIV e LV, CF/88), além de esvaziar o direito de petição e revisão humana insculpido expressamente no Artigo 20 da Lei Geral de Proteção de Dados (LGPD). Conforme jurisprudência consagrada pacífica do Supremo Tribunal Federal (STF - RE 567.985/MT), o limite de renda per capita de 1/4 de salário mínimo é indicador objetivo maleável, impossibilitando a presunção legal absoluta de renda familiar compartilhada por moradias concomitantes sem laudo de assistente social humano, como bem adverte a doutrina de Ingo Wolfgang Sarlet.",
